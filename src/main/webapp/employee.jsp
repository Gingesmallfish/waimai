		...
		<div id="employee-toolbar">
			<div class="my-toolbar-button">
				<a href="#" class="easyui-linkbutton" iconCls="icon-add"
					id="addEmployee" onclick="addEmployee(-1)" plain="true">添加</a>  <a href="#"
			...
			<div class="my-toolbar-search">
				...
				<select id="employeeStatus" name="employeeStatus" class="easyui-combobox" editable="false"
...
<div id="employee-dialog" class="easyui-dialog"
	...
	<form id="employee-form" method="post">
		<table class="employee_table">
			<tr>
				<td width="100"><label for="name">员工姓名:</label></td>
				<td><input type="text" name="name" id="name" class="easyui-textbox"
					data-options="prompt:'员工姓名'" style="width: 200px; height: 35px;" /></td>
			</tr>
			<tr>
				<td width="100"><label for="sex">员工性别:</label></td>
				<td>
					<select id="sex" name="sex" class="easyui-combobox" editable="false"
			...
			<tr>
				<td width="100"><label for="id_number">身份证号:</label></td>
				<td><input type="text" name="id_number" id="id_number" class="easyui-textbox"
						   data-options="prompt:'身份证号'" style="width: 200px; height: 35px;" /></td>
			</tr>
			<tr>
				<td width="100"><label for="phone">手机号:</label></td>
				<td><input type="text" name="phone" id="phone" class="easyui-textbox"
						   data-options="prompt:'手机号'" style="width:200px; height: 35px;" /></td>
			</tr>
		</table>
	</form>
</div>
